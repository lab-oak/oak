...
def loss(
    input: net.Battle::FrameTorch, output: net.OutputBuffers, args, print_flag=False
):
...
def main():
    ...
    encoded_frames = pyoak.Battle::Frame(args.batch_size)
    encoded_frames_torch = net.Battle::FrameTorch(encoded_frames)
